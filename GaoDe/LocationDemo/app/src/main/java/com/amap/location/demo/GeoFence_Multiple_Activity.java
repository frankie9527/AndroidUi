...
public class GeoFence_Multiple_Activity extends CheckPermissionsActivity
	...
	public void onMapClick(LatLng latLng) {
		...
		int id =rgFenceType.getCheckedRadioButtonId();
		if (id==R.id.rb_roundFence||id==R.id.rb_nearbyFence){
			centerLatLng = latLng;
		...
		}else if (id==R.id.rb_polygonFence){
	...
	private void addFence() {
		int id=rgFenceType.getCheckedRadioButtonId();
		if (id==R.id.rb_roundFence){
			addRoundFence();
		}else if (id==R.id.rb_polygonFence){
			addPolygonFence();
		}else if (id==R.id.rb_keywordFence){
			addKeywordFence();
		}else if (id==R.id.rb_nearbyFence){
			addNearbyFence();
		}else if (id==R.id.rb_districeFence){
			addDistrictFence();
		}
